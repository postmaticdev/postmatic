...
export default function CreatorPage() {
  ...
  const addKeyword = () => {
    if (newKeyword.trim() && !formData.keywords.find(k => k.text === newKeyword.trim())) {
      setFormData(prev => ({
        ...prev,
        keywords: [...prev.keywords, { id: Date.now().toString(), text: newKeyword.trim() }]
      }))
      setNewKeyword("")
    }
  }
      ...
      <div className="flex-1 p-8 space-y-8">
        ...
        <div className="flex justify-between items-start">
          <div className="space-y-1">
            <h1 className="text-3xl font-semibold text-gray-900 tracking-tight">Selamat datang kembali, Hayhasan</h1>
            <p className="text-gray-500 text-sm">Kelola desain Anda dan pantau pendapatan Anda</p>
          </div>
          <div className="bg-white px-4 py-3 rounded-xl border border-gray-200 shadow-sm">
            <p className="text-xs uppercase tracking-wider text-gray-500 font-medium">ID Kreator</p>
            ...
            <CardContent className="p-6">
              <div className="flex items-start justify-between">
                <div className="space-y-2">
                  <p className="text-sm font-medium text-gray-500">Total Desain</p>
                  <p className="text-3xl font-bold text-gray-900">1,045</p>
                  <div className="flex items-center space-x-1">
                    <TrendingUp className="h-4 w-4 text-emerald-500" />
                    <span className="text-sm font-medium text-emerald-600">+30%</span>
        ...
        <Card className="bg-white border-0 shadow-sm">
          <CardHeader className="border-b border-gray-100 pb-6">
            <div className="flex justify-between items-center">
              <div className="space-y-1">
                <CardTitle className="text-2xl font-semibold text-gray-900">Portofolio Desain</CardTitle>
                <p className="text-sm text-gray-500">Kelola template desain dan kreasi Anda</p>
              </div>
              <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                ...
                <DialogContent className="max-w-md">
                  ...
                  <div className="space-y-4 p-6">
                    ...
                    <UploadPhoto
                      label="Unggah Desain"
                      onImageChange={(file) => setFormData(prev => ({ ...prev, designFile: file }))}
                    />
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={formData.category} onValueChange={(value) => setFormData(prev => ({ ...prev, category: value }))}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="business-card">Kartu Nama</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
          ...
          <CardContent className="pt-6">
              ...
              {templates.map((template) => (
                <div key={template.id} className="group cursor-pointer">
                  ...
                  <div className="mt-3 space-y-1">
                    ...
                    <p className="text-blue-600 font-semibold text-sm">Rp {template.price.toLocaleString()}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="flex justify-center items-center mt-8 space-x-1">
              ...
              <Button variant="default" size="sm" className="h-9 w-9 p-0 bg-blue-600 hover:bg-blue-700 rounded-lg font-medium">
                1
              </Button>
              <Button variant="ghost" size="sm" className="h-9 w-9 p-0 rounded-lg hover:bg-gray-100 text-gray-700">
                2
              </Button>
              <Button variant="ghost" size="sm" className="h-9 w-9 p-0 rounded-lg hover:bg-gray-100 text-gray-700">
                3
        ...
        <Card className="bg-white border-0 shadow-sm">
          <CardHeader className="border-b border-gray-100 pb-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="space-y-1">
                <CardTitle className="text-2xl font-semibold text-gray-900">Manajemen Afiliator</CardTitle>
                <p className="text-sm text-gray-500">Kelola dan pantau mitra afiliasi Anda (5 pengguna aktif)</p>
              </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200">
                    <th className="pb-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Nama</th>
                    ...
                    <th className="pb-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Kode</th>
                    <th className="pb-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Total Pengeluaran</th>
                    <th className="pb-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Komisi</th>
                    <th className="pb-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Tanggal Dibayar</th>
                    <th className="pb-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Aksi</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  {affiliatorData.map((affiliator, index) => (
                    <tr key={index} className="hover:bg-gray-50/50 transition-colors duration-150">
                      <td className="py-4 font-medium text-gray-900">{affiliator.name}</td>
                      ...
                      <td className="py-4 font-mono text-sm font-medium text-gray-900">{affiliator.code}</td>
                      <td className="py-4 font-medium text-gray-900">{affiliator.totalSpend}</td>
                      <td className="py-4 font-medium text-gray-900">{affiliator.totalCommissions}</td>
                      <td className="py-4 text-gray-600">{affiliator.paidDate}</td>
                      <td className="py-4">
        ...
        <Card className="bg-white border-0 shadow-sm">
          <CardHeader className="pb-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <CardTitle className="text-xl font-semibold text-gray-900">Withdrawal Center</CardTitle>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              <div className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
                <p className="text-sm font-medium text-blue-900 mb-1">Total Balance</p>
              ...
              <div className="p-4 bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl border border-amber-100">
                ...
                <p className="text-2xl font-bold text-amber-900">Rp 156.000.000</p>
                <p className="text-xs text-amber-600 mt-1">Processing time: 7 working days</p>
              </div>
            </div>
            ...
            <div>
              <div className="mb-4">
                <p className="font-semibold text-gray-900 mb-1">Withdrawal History</p>
                <p className="text-sm text-gray-500">Track your withdrawal requests and transactions</p>
              </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-0.5">GoPlay ****5678</p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-0.5">Mandiri ****9012</p>
                      </div>
                    </div>
                    <div className="text-right">
